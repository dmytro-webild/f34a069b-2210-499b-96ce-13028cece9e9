...
export const metadata: Metadata = {
  title: "Wyzn Media - AI Lead Generation & Appointment Booking",  description: "Predictable client acquisition powered by AI. Automated lead generation, qualification, and booking for coaches, consultants, and service businesses.",  keywords: "lead generation, AI automation, appointment booking, qualified leads, client acquisition, SaaS",  metadataBase: new URL("https://wyznmedia.com"),
  alternates: {
    canonical: "https://wyznmedia.com"
  },
  openGraph: {
    title: "Wyzn Media - Predictable Client Acquisition",    description: "Build automated lead generation systems that attract, qualify, and book high-intent clients.",    url: "https://wyznmedia.com",    siteName: "Wyzn Media",    type: "website",    images: [
      {
        url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AQEKReAIV3UyO8Ouxkrw1K5Rfl/a-modern-clean-software-dashboard-interf-1772516714493-41a98465.png",        alt: "Wyzn Media AI Dashboard"
      }
    ]
  },
  twitter: {
    card: "summary_large_image",    title: "Wyzn Media - Predictable Client Acquisition",    description: "AI-powered lead generation and appointment booking system",    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_3AQEKReAIV3UyO8Ouxkrw1K5Rfl/a-modern-clean-software-dashboard-interf-1772516714493-41a98465.png"]
  },
  robots: {
    index: true,
    follow: true
